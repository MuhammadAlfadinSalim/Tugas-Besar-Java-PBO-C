...
public class MyForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        cboLantai = new javax.swing.JComboBox();
        ...
        jRadioButton5.setText("Buruk");

        jRadioButton6.setText("Pojok Ruang / Dekat Dosen");

        jRadioButton7.setText("Lainnya");

        jLabel18.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel18.setText("LCD");
        ...
        jRadioButton8.setText("Lebih > 1");

        jRadioButton9.setText("1");

        jRadioButton10.setText("Kurang");

        jRadioButton11.setText("Berfungsi");

        jRadioButton12.setText("Tidak");

        jRadioButton13.setText("Dekat Dosen");

        jRadioButton14.setText("Lainnya");

        jLabel22.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel22.setText("LAMPU");

        jLabel23.setText("Jumlah");

        jLabel24.setText("Kondisi");

        jLabel25.setText("Posisi");

        jRadioButton15.setText("lebih > 18");

        jRadioButton16.setText("18");

        jRadioButton17.setText("Kurang");

        jRadioButton18.setText("Baik");

        jRadioButton19.setText("Buruk");

        jRadioButton20.setText("Atap Ruang");

        jRadioButton21.setText("Lainnya");

        jLabel26.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel26.setText("KIPAS ANGIN");
        ...
        jRadioButton22.setText("Lebih > 2");

        jRadioButton23.setText("2");

        jRadioButton24.setText("Kurang");

        jRadioButton25.setText("Baik");

        jRadioButton26.setText("Buruk");

        jRadioButton27.setText("Atap Ruang");

        jRadioButton28.setText("Lainnya");

        jLabel30.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel30.setText("AIR CONDITIONER");
        ...
        jRadioButton29.setText("Lebih > 1");

        jRadioButton30.setText("1");

        jRadioButton31.setText("Kurang");

        jRadioButton32.setText("Baik");

        jRadioButton33.setText("Buruk");

        jRadioButton35.setText("Belakang / Samping");

        jLabel34.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel34.setText("CCTV");

        jLabel35.setText("Jumlah");

        jRadioButton36.setText("Lainnya");

        jRadioButton37.setText("2");

        jRadioButton38.setText("Kurang");

        jLabel36.setText("Kondisi");

        jRadioButton39.setText("Baik");

        jRadioButton40.setText("Buruk");

        jLabel37.setText("Posisi");

        jRadioButton41.setText("Depan dan Belakang");

        jLabel38.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel38.setText("IINTERNET");

        jLabel39.setText("SSID");

        jRadioButton42.setText("UMMHotspot");

        jRadioButton43.setText("Lainnya");
        ...
        jLabel40.setText("Kekokohan");

        jRadioButton34.setText("Ya");

        jRadioButton44.setText("Tidak");

        jLabel41.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel41.setText("Kunci Pintu / Jendela");

        jRadioButton45.setText("Ada");

        jRadioButton46.setText("Tidak");

        jLabel42.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel42.setText("Keamanan");

        jRadioButton47.setText("Aman");
        ...
        cboGedung.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Gedung Kuliah Bersama 1", "Gedung Kuliah Bersama 2", "Gedung Kuliah Bersama 3\t" }));
        cboGedung.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cboGedungActionPerformed(evt);
            }
        });

        cboLantai.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Lantai 1", "Lantai 2", "Lantai 3", "Lantai 4", "Lantai 5", "Lantai 6" }));
        cboLantai.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cboLantaiActionPerformed(evt);
            }
        });
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(cboGedung, 0, 165, Short.MAX_VALUE)
                    .addComponent(cboLantai, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addContainerGap())
        );
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel3)
                    .addComponent(cboLantai, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel4)
        ...
        jLabel10.setText("Jumlah Pintu");

        jLabel11.setText("Jumlah Jendela");

        jLabel8.setText("Lebar Ruang");

        jLabel9.setText("Jumlah Kursi");

        jLabel7.setText("Panjang Ruang");
        ...
        checkbox9.setLabel("Baik");

        checkbox1.setLabel("Baik");

        checkbox7.setLabel("Baik");

        checkbox10.setLabel("Buruk");

        checkbox3.setLabel("Baik");

        checkbox4.setLabel("Buruk");

        jLabel44.setText("Dinding");

        checkbox6.setLabel("Buruk");

        checkbox8.setLabel("Buruk");

        jLabel46.setText("Pintu");

        checkbox2.setLabel("Buruk");

        checkbox5.setLabel("Baik");

        jLabel43.setText("Lantai");

        jLabel47.setText("Jendela");

        jLabel45.setText("Atap");
        ...
        jLabel48.setText("Sirkulasi Udara");

        jLabel49.setText("Rentang Cahaya");

        jLabel50.setText("Kelembaban");

        jLabel51.setText("Suhu");

        jRadioButton49.setText("Lancar");

        jRadioButton50.setText("Tidak");
        ...
        jPanel7Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel7Layout.createSequentialGroup()
                ...
                .addGroup(jPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel7Layout.createSequentialGroup()
                        .addComponent(textField8, javax.swing.GroupLayout.PREFERRED_SIZE, 126, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jLabel53))
                    .addComponent(textField6, javax.swing.GroupLayout.PREFERRED_SIZE, 126, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGroup(jPanel7Layout.createSequentialGroup()
                        .addComponent(textField7, javax.swing.GroupLayout.PREFERRED_SIZE, 126, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void cboGedungActionPerformed(java.awt.event.ActionEvent evt) {                                          
        // TODO add your handling code here:
    }                                         

    private void cboLantaiActionPerformed(java.awt.event.ActionEvent evt) {                                          
        // TODO add your handling code here:
    }                                         
    ...
    private javax.swing.JComboBox cboLantai;
